...
//            is RequestResult.Error -> {
//              if (it.error !== null) {
//                torErrCb(this.reactApplicationContext.javaScriptContextHolder.get(), cbPtr, it.error.localizedMessage);
////                mPromise(it.message);
//              } else if (it.result != null) {
//                torErrCb(this.reactApplicationContext.javaScriptContextHolder.get(), cbPtr, it.result.toString());
////                  mPromise(it.message);
//              }
//            }
//            is RequestResult.Success -> {
////                mPromise(it.result)
//              torCbMap(this.reactApplicationContext.javaScriptContextHolder.get(), cbPtr, it.result);
//            }
//            else -> {
//              torErrCb(this.reactApplicationContext.javaScriptContextHolder.get(), cbPtr,"Unable to process RequestResult");
//              //mPromise(
//              //  "Unable to process RequestResult",
...
//      } catch (e: Exception) {
//        Log.d("TorBridge", "error on request: $e")
//        torErrCb(this.reactApplicationContext.javaScriptContextHolder.get(), cbPtr,e.localizedMessage);
////        promise.reject(e)
//      }
//    }
//    return 0;
